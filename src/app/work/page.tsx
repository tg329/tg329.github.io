...
export default function Work() {
    return (
        <div className="grid grid-rows-[auto_1fr_auto] items-center justify-items-center min-h-screen font-[family-name:var(--font-geist-sans)]">
            <Navbar />
            <main className="flex flex-col gap-4 row-start-2 items-center pt-10">
                ...
                <div className="text-center mt-2 mb-8 flex flex-col items-center">
                    <span className="mb-4">...and this website!</span>
